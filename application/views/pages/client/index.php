...
<html lang="en">
  ...
  <body>
	...
	<section>
		...
		<div class="content">
			<h1 class="text-center mt-4 pt-4">Pembayaran</h1>
			<p class="my-4">
				<div class="container">
					<div class="row row-cols-1 row-cols-md-3 g-4">
						...
						foreach ($pembayaran as $key => $value) { ?>
							...
							<img src="<?= base_url('assets/file/pembayaran/'.$value->qris) ?>" style="width: 100%;height:300px;object-fit: cover;" class="card-img-top" alt="...">
							<div class="card-body">
